...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('yummy_recipephoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yummy.Recipe'])),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yummy.Photo'])),
        ...
        db.send_create_signal('yummy', ['RecipePhoto'])

        # Adding unique constraint on 'RecipePhoto', fields ['recipe', 'photo']
        db.create_unique('yummy_recipephoto', ['recipe_id', 'photo_id'])

        # Deleting field 'Photo.slug'
        db.delete_column('yummy_photo', 'slug')

        # Adding field 'Photo.width'
        db.add_column('yummy_photo', 'width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.height'
        db.add_column('yummy_photo', 'height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Photo.image'
        db.alter_column('yummy_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

    def backwards(self, orm):
        # Removing unique constraint on 'RecipePhoto', fields ['recipe', 'photo']
        db.delete_unique('yummy_recipephoto', ['recipe_id', 'photo_id'])

        # Deleting model 'RecipePhoto'
        db.delete_table('yummy_recipephoto')
        ...
        db.delete_column('yummy_photo', 'width')

        # Deleting field 'Photo.height'
        db.delete_column('yummy_photo', 'height')


        # Changing field 'Photo.image'
        db.alter_column('yummy_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
