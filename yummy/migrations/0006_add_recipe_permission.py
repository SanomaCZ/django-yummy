...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['auth.permission'].objects.create(content_type=ct, codename='approve_recipe', defaults=dict(name=u'Can approve recipe'))

    def backwards(self, orm):
        "Write your backwards methods here."
        ct = orm['contenttypes.ContentType'].objects.get(model='recipe', app_label='yummy')
        orm['auth.permission'].objects.get(content_type=ct, codename='approve_recipe').delete()
