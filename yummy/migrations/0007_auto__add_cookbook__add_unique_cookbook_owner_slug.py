...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('yummy_cookbook', (
        ...
        db.send_create_signal('yummy', ['CookBook'])
        ...
        # Adding unique constraint on 'CookBook', fields ['owner', 'slug']
        db.create_unique('yummy_cookbook', ['owner_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'CookBook', fields ['owner', 'slug']
        db.delete_unique('yummy_cookbook', ['owner_id', 'slug'])

        # Deleting model 'CookBook'
        db.delete_table('yummy_cookbook')
