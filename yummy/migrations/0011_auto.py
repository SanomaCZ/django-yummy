...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field consumers on 'Recipe'
        db.delete_table('yummy_recipe_consumers')


    def backwards(self, orm):
        # Adding M2M table for field consumers on 'Recipe'
        db.create_table('yummy_recipe_consumers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recipe', models.ForeignKey(orm['yummy.recipe'], null=False)),
            ('consumer', models.ForeignKey(orm['yummy.consumer'], null=False))
        ))
        db.create_unique('yummy_recipe_consumers', ['recipe_id', 'consumer_id'])
