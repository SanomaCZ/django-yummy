...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ingredient.default_unit'
        db.alter_column('yummy_ingredient', 'default_unit', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ingredient.default_unit'
        raise RuntimeError("Cannot reverse this migration. 'Ingredient.default_unit' and its values cannot be restored.")
