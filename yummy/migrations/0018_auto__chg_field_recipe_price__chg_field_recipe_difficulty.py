...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('yummy_recipe', 'price', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Recipe.difficulty'
        db.alter_column('yummy_recipe', 'difficulty', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Recipe.price'
        db.alter_column('yummy_recipe', 'price', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Recipe.difficulty'
        db.alter_column('yummy_recipe', 'difficulty', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
