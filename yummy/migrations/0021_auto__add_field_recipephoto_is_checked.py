...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipePhoto.is_checked'
        db.add_column('yummy_recipephoto', 'is_checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipePhoto.is_checked'
        db.delete_column('yummy_recipephoto', 'is_checked')
