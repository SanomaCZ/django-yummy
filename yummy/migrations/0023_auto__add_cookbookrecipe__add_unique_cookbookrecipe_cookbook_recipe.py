...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CookBookRecipe'
        db.create_table('yummy_cookbookrecipe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cookbook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yummy.CookBook'])),
        ...
        db.send_create_signal('yummy', ['CookBookRecipe'])

        # Adding unique constraint on 'CookBookRecipe', fields ['cookbook', 'recipe']
        db.create_unique('yummy_cookbookrecipe', ['cookbook_id', 'recipe_id'])

        # Removing M2M table for field recipes on 'CookBook'
        db.delete_table('yummy_cookbook_recipes')


    def backwards(self, orm):
        # Removing unique constraint on 'CookBookRecipe', fields ['cookbook', 'recipe']
        db.delete_unique('yummy_cookbookrecipe', ['cookbook_id', 'recipe_id'])

        # Deleting model 'CookBookRecipe'
        db.delete_table('yummy_cookbookrecipe')

        # Adding M2M table for field recipes on 'CookBook'
        db.create_table('yummy_cookbook_recipes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cookbook', models.ForeignKey(orm['yummy.cookbook'], null=False)),
            ('recipe', models.ForeignKey(orm['yummy.recipe'], null=False))
        ))
        db.create_unique('yummy_cookbook_recipes', ['cookbook_id', 'recipe_id'])
    ...
    models = {
        ...
        'yummy.cookbook': {
            ...
            'recipes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['yummy.Recipe']", 'through': "orm['yummy.CookBookRecipe']", 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '128'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        'yummy.cookbookrecipe': {
            'Meta': {'unique_together': "(('cookbook', 'recipe'),)", 'object_name': 'CookBookRecipe'},
            'added': ('django.db.models.fields.DateField', [], {}),
            'cookbook': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['yummy.CookBook']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'yummy.recipe': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'cuisines': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['yummy.Cuisine']", 'symmetrical': 'False', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
