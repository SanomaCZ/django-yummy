...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Recipe', fields ['is_approved']
        db.create_index('yummy_recipe', ['is_approved'])

        # Adding index on 'Recipe', fields ['price']
        db.create_index('yummy_recipe', ['price'])

        # Adding index on 'Recipe', fields ['difficulty']
        db.create_index('yummy_recipe', ['difficulty'])

        # Adding index on 'IngredientInRecipe', fields ['order']
        db.create_index('yummy_ingredientinrecipe', ['order'])

        # Adding unique constraint on 'IngredientInRecipe', fields ['recipe', 'order']
        db.create_unique('yummy_ingredientinrecipe', ['recipe_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'IngredientInRecipe', fields ['recipe', 'order']
        db.delete_unique('yummy_ingredientinrecipe', ['recipe_id', 'order'])

        # Removing index on 'IngredientInRecipe', fields ['order']
        db.delete_index('yummy_ingredientinrecipe', ['order'])

        # Removing index on 'Recipe', fields ['difficulty']
        db.delete_index('yummy_recipe', ['difficulty'])

        # Removing index on 'Recipe', fields ['price']
        db.delete_index('yummy_recipe', ['price'])

        # Removing index on 'Recipe', fields ['is_approved']
        db.delete_index('yummy_recipe', ['is_approved'])
