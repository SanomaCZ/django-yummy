...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeekMenu'
        db.create_table('yummy_weekmenu', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.IntegerField')()),
            ('soup', self.gf('django.db.models.fields.related.ForeignKey')(related_name='menu_soup', null=True, to=orm['yummy.Recipe'])),
            ('meal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='menu_meal', null=True, to=orm['yummy.Recipe'])),
            ('dessert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='menu_dessert', null=True, to=orm['yummy.Recipe'])),
            ('even_week', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('yummy', ['WeekMenu'])

        # Adding unique constraint on 'WeekMenu', fields ['day', 'even_week']
        db.create_unique('yummy_weekmenu', ['day', 'even_week'])


    def backwards(self, orm):
        # Removing unique constraint on 'WeekMenu', fields ['day', 'even_week']
        db.delete_unique('yummy_weekmenu', ['day', 'even_week'])

        # Deleting model 'WeekMenu'
        db.delete_table('yummy_weekmenu')
    ...
    models = {
        ...
        'yummy.weekmenu': {
            ...
            'dessert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'menu_dessert'", 'null': 'True', 'to': "orm['yummy.Recipe']"}),
            'even_week': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'menu_meal'", 'null': 'True', 'to': "orm['yummy.Recipe']"}),
            'soup': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'menu_soup'", 'null': 'True', 'to': "orm['yummy.Recipe']"})
        }
    }
