...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'RecipePhoto', fields ['order']
        db.create_index('yummy_recipephoto', ['order'])

        # Adding unique constraint on 'RecipePhoto', fields ['recipe', 'order']
        db.create_unique('yummy_recipephoto', ['recipe_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'RecipePhoto', fields ['recipe', 'order']
        db.delete_unique('yummy_recipephoto', ['recipe_id', 'order'])

        # Removing index on 'RecipePhoto', fields ['order']
        db.delete_index('yummy_recipephoto', ['order'])
    ...
    models = {
        ...
        'yummy.recipe': {
            ...
            'consumers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['yummy.Consumer']", 'symmetrical': 'False', 'blank': 'True'}),
