...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ingredient.is_approved'
        db.add_column('yummy_ingredient', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ingredient.is_approved'
        db.delete_column('yummy_ingredient', 'is_approved')
