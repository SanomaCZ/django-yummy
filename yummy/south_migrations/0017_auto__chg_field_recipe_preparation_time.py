...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.preparation_time'
        db.alter_column('yummy_recipe', 'preparation_time', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Recipe.preparation_time'
        raise RuntimeError("Cannot reverse this migration. 'Recipe.preparation_time' and its values cannot be restored.")
    ...
    models = {
        ...
        'yummy.ingredient': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['yummy.IngredientGroup']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
