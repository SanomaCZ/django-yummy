...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('yummy_photo', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.created'
        db.delete_column('yummy_photo', 'created')
