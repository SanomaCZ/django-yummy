...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'IngredientInRecipeGroup', fields ['order']
        db.create_index('yummy_ingredientinrecipegroup', ['order'])


    def backwards(self, orm):
        # Removing index on 'IngredientInRecipeGroup', fields ['order']
        db.delete_index('yummy_ingredientinrecipegroup', ['order'])
    ...
    models = {
        ...
        'yummy.ingredientinrecipe': {
            ...
            'order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'db_index': 'True'}),
